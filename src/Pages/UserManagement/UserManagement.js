  ...
  const deleteUser = async (i) => {
    try {
      let result = await http.delete(
        `/api/QuanLyNguoiDung/XoaNguoiDung?TaiKhoan=${i}`
      );
        ...
        return (
          <tr style={{ width: "100%" }}>
            ...
            <td style={{ width: "27%" }}>
              <button
                onClick={() => {
                  getUser(item.taiKhoan);
                }}
                type="button"
                className="btn mx-1 text-wrap"
                id="btnThem"
                data-toggle="modal"
                data-target="#userReg"
              >
              ...
              <button
                ...
                className="btn btn-warning m-1 text-wrap"
                data-toggle="modal"
              ...
              <button
                ...
                className="btn btn-danger mx-1 text-wrap"
              >
                Xóa
              </button>
            </td>
      ...
      <div className="card-header myCardHeader container-fluid">
        <div className="row">
          <div className="col-auto mr-auto row item">
            <button
              id="dropdown-toggle menu-icon dropdownMenuButton2"
              data-toggle="dropdown"
              className="btn btn-light my-1 item unhide"
            >
              <span id="menu-icon">
            ...
            <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton2">
              <li>
                <a className="dropdown-item" href="/admin/quanlynguoidung">
                  Quản lý người dùng
                </a>
              </li>
              <li>
                <a className="dropdown-item" href="/admin/quanlykhoahoc">
                  Quản lý khóa học
                </a>
              </li>
            </ul>
          ...
          <thead className="text-dark bg-light">
            <tr style={{ width: "100%" }}>
              ...
              <th className="align-middle" style={{ width: "25%" }}>
                <em className="fa fa-cog text-wrap" />
              </th>
            </tr>
          </thead>
          <tbody id="tableDanhSach">{renderUserList(currentItems)}</tbody>
        </table>
      </div>
