                      ...
                      <div className="cardBlogContent">
                        ...
                        <div className="timeBlogCourse">
                          <div className="reviewBlog">
                            <span>
                              <i className="far fa-thumbs-up"></i> 300
                            </span>
                            <span>
                              <i className="far fa-comment"></i> 500
                            </span>
                            <span>
                              <i className="fas fa-eye"></i> 200
                            </span>
                          </div>
                          <p>
                            Đăng bởi<span> Thanh Tiến</span>
                          </p>
                        </div>
                  ...
                  <div className="col-xl-6 mb-4">
                    <div className="cardBlog">
                      <div className="cardBlogContent">
                        <div className="imgCardBlog">
                          <img
                            src="https://cdn.fullstack.edu.vn/f8-learning/blog_posts/1637/61b175b3debf2.jpg"
                            onError={(e) => {
                              e.target.onerror = null;
                              e.target.src =
                                "https://cdn.fullstack.edu.vn/f8-learning/blog_posts/1653/61b46a3d757cc.png";
                        ...
                        <div className="timeBlogCourse">
                          ...
                          <p>
                            Đăng bởi<span> Bảo</span>
                          </p>
                        </div>
                        <p className="colorCardTitle">
                          Custom theme Material UI với TypeScript đơn giản, hiệu
                          quả...
                        </p>
                        <button className="btnGlobal btnCardBlog">
                          <a href="">Xem thêm</a>
                  ...
                  <div className="col-xl-6 mb-4">
                    <div className="cardBlog">
                      <div className="cardBlogContent">
                        <div className="imgCardBlog">
                          <img
                            src="https://cdn.fullstack.edu.vn/f8-learning/blog_posts/1463/61a1bbd28851c.jpg"
                            onError={(e) => {
                              e.target.onerror = null;
                              e.target.src =
                                "https://cdn.fullstack.edu.vn/f8-learning/blog_posts/1463/61a1bbd28851c.jpgog_posts/1653/61b46a3d757cc.png";
                            }}
                            alt=""
                          />
                        </div>
                        ...
                        <p className="colorCardTitle">
                          Trắc hẳn ai cũng biết một trang web thì không thể nào
                          thiếu đi HTML và HTML làm nên cấu trúc của một trang
                          web...
                        </p>
                        <button className="btnGlobal btnCardBlog">
                          <a href="">Xem thêm</a>
                    ...
                    <div className="cardBlog">
                      <div className="cardBlogContent">
                        ...
                        <p className="colorCardTitle">
                          ...
                          target="_blank" cho thẻ a để khi người dùng click vô
                          sẽ mở liên kết trên một tab mới...
                        </p>
                        <button className="btnGlobal btnCardBlog">
                          <a href="">Xem thêm</a>
                        </button>
                ...
                <div className="blogRightBox">
                  ...
                  <div className="postBlog">
                    ...
                    <div className="imgPost">
                      <img
                        src={
                          require("../../Assets/Img/imgInstrutors/instrutor13.jpg")
                            .default
                        }
                        alt=""
                      />
                      <span className="colorCardTitle"> Bảo</span>
                    </div>
                  </div>
                  <div className="postBlog">
                    <img
                    ...
                    <div className="imgPost">
                      <img
                        src={
                          require("../../Assets/Img/imgInstrutors/instrutor12.jpg")
                            .default
                        }
                        alt=""
                      />
                      <span className="colorCardTitle">Thanh Sang</span>
                    </div>
                  </div>
                  <div className="postBlog">
                    <img
                    ...
                    <div className="imgPost">
                      <img
                        ...
                        alt=""
                      />
                      <span className="colorCardTitle"> Tiến Dev</span>
                    </div>
                  </div>
                </div>
              </div>
