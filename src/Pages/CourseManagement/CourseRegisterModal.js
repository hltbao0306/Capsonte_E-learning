...
import {
  getUserListNotConfirmed,
  getUserListConfirmed,
...
export default function CourseRegisterModal(props) {
  ...
  const UserListNotConfirmed = useSelector(
    (state) => state.UserReducer.UserListNotConfirmed
  );
  const UserListConfirmed = useSelector(
    (state) => state.UserReducer.UserListConfirmed
  );
  const UserListNotRegister = useSelector(
    (state) => state.UserReducer.UserListNotRegister
  );
  const UserListNotRegisterSearch = useSelector(
    (state) => state.UserReducer.UserListNotRegisterSearch
  );
  ...
  useEffect(() => {
    ...
    setnotConfirmedItems(
      UserListNotConfirmed && UserListNotConfirmed.slice(itemOffset1, endOffset)
    );
    setPageCount1(
      Math.ceil(UserListNotConfirmed && UserListNotConfirmed.length / 2)
    );
  ...
  useEffect(() => {
    ...
    setConfirmedItems(
      UserListConfirmed && UserListConfirmed.slice(itemOffset2, endOffset)
    );
  ...
  const renderUserListNotConfirmed = (notConfirmedItems) => {
    return (
      notConfirmedItems &&
      notConfirmedItems.map((item, index) => {
        return (
          <tr>
            ...
            <td>
              <button
                onClick={() => {
                  regUserByCourse(props.course, item.taiKhoan);
                }}
                className="btn mx-1"
                id="btnThem"
              >
              ...
              <button
                onClick={() => {
                  deleteUserByCourse(props.course, item.taiKhoan);
                }}
            ...
            <div className="border-bottom border-secondary">
              <div className="row">
                ...
                <div className="col-3">
                  <a
                    onClick={() => {
                      regUserByCourse(props.course, RegItem.taiKhoan);
                    }}
          ...
          <div className="modal-body ">
            <div className="border-bottom border-secondary">
              ...
              <table class="table table-center table-hover myTable table-striped">
                ...
                <tbody>{renderUserListNotConfirmed(notConfirmedItems)}</tbody>
              </table>
              <ReactPaginate
                nextLabel="Sau >"
          ...
          <div className="modal-body">
            <div className="">
              ...
              <table class="table table-center table-hover myTable table-striped">
                ...
                <tbody>{renderUserListConfirmed(confirmedItems)}</tbody>
              </table>
              <ReactPaginate
                nextLabel="Sau >"
                pageRangeDisplayed={2}
